<li><h5 style="margin:8px 5px 0 0;">Language:</h5></li><li id="syntaxhighlighting" style="width: auto; background: #fff;">
    <select id="syntaxes" onchange="require('ep_etherpad-lite/static/js/pad_cookie').padcookie.setPref('SH_BRUSH', this.options[this.selectedIndex].value); window.location.reload();">
        ...
        <option value="dos">DOS batch</option>
        ...
        <option value="ruleslanguage">Oracle Rules</option>
